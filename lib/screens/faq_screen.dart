              ...
              _faqCard(context, [
                ...
                const _FaqItem(
                  ...
                  answer:
                      ...
                      '調査」（いずれも2000年度）をもとに、日本小児内分泌学会が'
                      '公開しているLMS法の標準値を使用しています。',
                ),
              ]),
              ...
              _faqCard(context, [
                ...
                const _FaqItem(
                  ...
                  answer:
                      ...
                      '同じOS・同じサインイン方法の新しい端末で、同じアカウントに'
                      'サインインすると記録を復元できます。AndroidとiPhoneの間では'
                      'サインイン方法が異なるため、下記の手動バックアップを'
                      '使用してください。Pro版の購入は各ストアで管理されるため、'
                      'Google PlayとApp Storeの間では引き継がれません。\n\n'
                      '写真（アイコン・お誕生日の思い出）は'
