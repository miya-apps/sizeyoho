              ...
              _faqCard(context, [
                ...
                const _FaqItem(
                  ...
                  answer:
                      ...
                      'ONにすると、保存した画像（成長曲線・SDスコア・'
                      'サイズガイド）には名前の代わりにお子様のアイコン'
                      'だけが表示されます。アイコンに写真を設定していても、'
                      '画像には写真ではなく選択中のアイコンの絵柄を使います。\n\n'
                      '受診レポート（PDF）とファイル名は「第一子」'
                      '「第二子」…の表記になります。順番は登録中のお子様の'
                      '生まれた順で、双子など同日生まれの場合は登録順です。'
                      'アプリ内の表示は実名のまま変わりません。',
                ),
                const _FaqItem(
