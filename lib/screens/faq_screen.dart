              ...
              _faqCard(context, [
                ...
                const _FaqItem(
                  ...
                  answer:
                      ...
                      '切り上げたものが靴サイズの目安です。\n'
                      '④ 1ヶ月ずつ先読みして、靴サイズがワンサイズ（0.5cm）'
                      '上がる月を「買い替えおすすめ時期」としています。\n\n'
                      'サイズの上がり幅は常に 0.5cm ずつですが、上がるまでの'
                      '期間は一律ではありません。身長の伸びが速い時期（乳幼児期）'
                      'は数ヶ月おき、成長がゆるやかになるにつれて間隔が'
                      '長くなります。\n\n'
                      '購入した靴のサイズも記録すると、「予測サイズが購入した'
                      'サイズを超える月」＝いまの靴がきつくなる時期を、次の'
                      '買い替え目安として表示します。\n\n'
                ...
                const _FaqItem(
                  ...
                  answer:
                      '設定 → データ管理の「書き出し時に名前を伏せる」を'
                      'ONにすると、受診レポート（PDF）とサイズガイド画像に'
                      '載る名前が「第一子」「第二子」…の表記になります'
                      '（ファイル名も同様）。\n\n'
                      '順番は登録中のお子様の生まれた順で、双子など同日'
                      '生まれの場合は登録順です。アプリ内の表示は実名の'
                      'まま変わりません。',
                ),
                const _FaqItem(
