...
set HTML=file:///C:/grow_app/docs/store-assets/slide-01-growth-curve.html
set OUT=C:\grow_app\docs\store-assets\slide-01-growth-curve.png
...
if exist "%OUT%" (
  ...
  echo 失敗しました。Chromeがインストールされているか確認してください。
  pause
)
